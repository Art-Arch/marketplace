                        ...
                        {singleTabs.map(({name, path}) => (
                            <div
                                className={classNames(
                                    ...
                                    "text-lg font-extrabold text-mjol-blue-light hover:text-gray-900"
                                )}>
                                {name}
                            </div>
                        ))}
                ...
                <Popover.Panel focus
                    ...
                    <div
                        ...
                        <div key="Explore" className="py-6 px-5 space-y-6">
                            <div className="text-mjol-blue-light">Explore:</div>
                            <SmallNavBar tabs={exploreTabs}/>
                        </div>
                        <div key="Create" className="py-6 px-5 space-y-6">
                            <div className="text-mjol-blue-light">Create:</div>
