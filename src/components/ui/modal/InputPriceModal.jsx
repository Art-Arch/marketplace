...
import TokenSVG from "../icons/archway/TokenSVG";
                        ...
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-6 text-center">
                                ...
                                <div className="inline-flex">
                                    ...
                                    />
                                    <div className="mt-2"><TokenSVG/></div>
                                </div>
                                <div></div>

                                <button data-modal-toggle="popup-modal" type="button"
                                        onClick={() => onClick(price)}
                                        className="text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    Complete
                                </button>
